...
$this->breadcrumbs = ['Orders' => ['index'], 'Manage'];
...
<div class="max-w-7xl mx-auto px-6 py-10">
        ...
        <div class="flex space-x-5">
            <a href="<?php echo $this->createUrl('create'); ?>"
               class="px-4 py-2 text-sm bg-emerald-600 text-white rounded hover:bg-emerald-700 transition">
                <i class="ph ph-plus mr-1"></i> Create Order
            </a>
    ...
    <?php $this->widget('zii.widgets.grid.CGridView', [
        ...
        'columns' => [
            ...
            [
                'name' => 'status',
                'value' => 'CHtml::encode($data->status == 0 ? "Pending" : ($data->status == 1 ? "Accepted" : "Shipped"))',
                'filter' => [0 => 'Pending', 1 => 'Accepted', 2 => 'Shipped'],
            ],
            [
                'class' => 'CButtonColumn',
