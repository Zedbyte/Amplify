<div class="max-w-7xl mx-auto my-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        class="bg-white shadow rounded-lg p-4 border hover:shadow-md transition">
            <h2 class="text-lg font-semibold text-black mb-2">
                <i class="ph ph-guitar text-xl mr-1"></i> Products
            </h2>
            <p class="text-sm text-gray-600">Create, update and manage products listed in your store.</p>
        </a>
        ...
        class="bg-white shadow rounded-lg p-4 border hover:shadow-md transition">
            ...
            <p class="text-sm text-gray-600">Add, edit or organize product categories.</p>
        </a>
        ...
        class="bg-white shadow rounded-lg p-4 border hover:shadow-md transition">
            ...
            <p class="text-sm text-gray-600">Manage brand listings associated with products.</p>
        </a>
        ...
        class="bg-white shadow rounded-lg p-4 border hover:shadow-md transition">
            ...
            <p class="text-sm text-gray-600">View and update customer orders and statuses.</p>
        </a>
        ...
        class="bg-white shadow rounded-lg p-4 border hover:shadow-md transition">
            ...
            <p class="text-sm text-gray-600">Inspect and modify items included in orders.</p>
        </a>
        ...
        class="bg-white shadow rounded-lg p-4 border hover:shadow-md transition">
            ...
            <p class="text-sm text-gray-600">Monitor and edit payment records linked to orders.</p>
        </a>
        ...
        class="bg-white shadow rounded-lg p-4 border hover:shadow-md transition">
            ...
            <p class="text-sm text-gray-600">Manage shipment details and logistics data.</p>
        </a>
        ...
        class="bg-white shadow rounded-lg p-4 border hover:shadow-md transition">
            ...
            <p class="text-sm text-gray-600">Edit customer information and profiles.</p>
        </a>
        ...
        class="bg-white shadow rounded-lg p-4 border hover:shadow-md transition">
            ...
            <p class="text-sm text-gray-600">Manage all registered users and roles.</p>
        </a>
