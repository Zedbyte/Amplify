...
$this->breadcrumbs = ['Order Items' => ['index'], 'Item #' . $model->id];
?>
...
<div class="max-w-4xl mx-auto px-6 py-10">
    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-2xl font-bold text-gray-900">View Order Item #<?php echo CHtml::encode($model->id); ?></h1>
        </div>
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="text-base font-medium text-gray-800"><?php echo CHtml::encode($model->quantity); ?></div>
            </div>

            <div>
                <div class="text-sm text-gray-500">Price</div>
                <div class="text-base font-medium text-gray-800">$<?php echo CHtml::encode($model->price); ?></div>
            </div>

            <div>
                <div class="text-sm text-gray-500">Product ID</div>
                <div class="text-base font-medium text-gray-800"><?php echo CHtml::encode($model->product_id); ?></div>
            </div>

            <div>
                <div class="text-sm text-gray-500">Order ID</div>
                <div class="text-base font-medium text-gray-800"><?php echo CHtml::encode($model->order_id); ?></div>
            </div>
            ...
            <div>
                ...
                <div class="text-base font-medium text-gray-800">
                    <?php
                        ...
                        echo isset($statuses[$model->status]) ? $statuses[$model->status] : 'Unknown';
                    ?>
                </div>
            </div>
