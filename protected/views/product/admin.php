...
$this->breadcrumbs = ['Products' => ['index'], 'Manage'];
...
<div class="max-w-7xl mx-auto px-6 py-10">
    ...
    <p class="text-sm text-gray-600 mb-4">
        You may optionally enter a comparison operator (<code class="px-1 py-0.5 bg-gray-100 text-xs text-gray-700 rounded">&lt;</code>,
    ...
    <?php $this->widget('zii.widgets.grid.CGridView', [
        ...
        'htmlOptions' => ['class' => 'overflow-x-auto line-clamp-2'],
        ...
        'columns' => [
            ...
            [
				'name' => 'description',
				'type' => 'raw',
				'value' => 'CHtml::tag("div", ["class" => "line-clamp-2 max-w-xs text-ellipsis overflow-hidden"], CHtml::encode($data->description))',
				'htmlOptions' => ['style' => 'max-width: 250px;'],
			],
            'price',
            'stock',
			[
				...
				'buttons' => [
					'view' => [
						...
						'imageUrl' => false,
						'encodeLabel' => false,
						'options' => array('class' => 'text-gray-600'),
					],
					'update' => [
						'label' => '<i class="ph ph-pencil-simple"></i>',
						'imageUrl' => false,
						'encodeLabel' => false,
						'options' => array('class' => 'text-blue-600'),
					],
					'delete' => [
